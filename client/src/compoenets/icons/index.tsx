...
export function LocationIcon({ className = "text-gold-primary flex-shrink-0", size = 14 }: IconProps) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={size}
...
export function EmailIcon({ className = "text-gold-primary flex-shrink-0", size = 14 }: IconProps) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={size}
...
export function PhoneIcon({ className = "text-gold-primary flex-shrink-0", size = 14 }: IconProps) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={size}
